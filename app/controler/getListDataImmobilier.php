<?php
    ...
    $dataAll_SQL = 'SELECT * FROM articles_annonces_immobilier ORDER BY id DESC';
                  ...
                  <div class="box-annonce row">
                       <div class="col-md-12" style="padding: 0px;">
                            ...
                            <div class="content-info col-md-8" style="padding: ;">
                                 <h3>
                                      <a href="?/p=details&?id=<?= base64_encode($id_annonce)."&?ts=".base64_encode($categories) ?>" class="titre-annonce"><?= truncate($titleAnnonce, 30) ?></a>
                                 </h3>
