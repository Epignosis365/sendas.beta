		...
		if (!empty($descriptionAnnonce)) {
			if (!empty($numeroTelephone)) {
				...
				if (is_numeric($numeroTelephone)) {
					...
					$sql_inser = "INSERT INTO articles_annonce_services (id_crypt, id_annonce, id_annonceur, categories, titre_annonce, adresse_annonceur, description, type_annonce, prix_marchandise, type_annonceur, province, ville, codePostal, adress_marchanise, numero_telephone, photos_array, date_annoncee, time_stamp)
						VALUES(:id_crypt, :id_annonce, :id_annonceur, :categories, :titre_annonce, :adresse_annonceur, :description, :type_annonce, :prix_marchandise, :type_annonceur, :province, :ville, :codePostal, :adress_marchanise, :numero_telephone, :photos_array, :date_annoncee, :time_stamp)";
