<?php
  ...
  $dataAll_SQL_3 = 'SELECT * FROM `articles_annonce_services` WHERE `id_annonce` = ?';
  $dataAll_SQLstm_3 = $bdd->prepare($dataAll_SQL_3);
  $dataAll_SQLstm_3->execute(array($VTr)) or die(print_r($dataAll_SQLstm_3->errorInfo()));
  $result_dataAll_3 = $dataAll_SQLstm_3->fetch();
  $count_dataAll_3  = $dataAll_SQLstm_3->rowCount();

  $id_annonceur      = $result_dataAll_3['id_annonceur'];
  $id_annonce      = $result_dataAll_3['id_annonce'];
  $id_crypt          = $result_dataAll_3['id_crypt'];
  $titleAnnonce      = $result_dataAll_3['titre_annonce'];
  $categories        = $result_dataAll_3['categories'];
  $adresse_annonceur = $result_dataAll_3['adresse_annonceur'];
  $description       = $result_dataAll_3['description'];
  $type_annonce      = $result_dataAll_3['type_annonce'];

  $taille        = $result_dataAll_3['taille'];
  $couleur       = $result_dataAll_3['couleur'];
  $unite_piece   = $result_dataAll_3['unite_piece'];

  $prix_marchandise  = $result_dataAll_3['prix_marchandise'];
  $type_annonceur    = $result_dataAll_3['type_annonceur'];
  $marque            = $result_dataAll_3['marque'];
  $modele            = $result_dataAll_3['modele'];
  $chambres          = $result_dataAll_3['chambres'];
  $sallons           = $result_dataAll_3['sallons'];
  $salleDeBains      = $result_dataAll_3['salleDeBains'];
  $codePostal        = $result_dataAll_3['codePostal'];
  $adress_marchanise = $result_dataAll_3['adress_marchanise'];
  $numero_telephone  = $result_dataAll_3['numero_telephone'];
  $photos_array      = $result_dataAll_3['photos_array'];
  $date_annoncee     = $result_dataAll_3['date_annoncee'];
  $time_stamp        = $result_dataAll_3['time_stamp'];
...
<script type="text/javascript">
  function SubmitFormDataFile() {
    ...
    $.ajax({
        url: "app/model/str-update-service-annonce.php",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
      ...
      <form id="form_publierAnnonce" name="form_publierAnnonce" method="post" enctype="multipart/form-data">
        <div class="tab-content col-md-12" id="tab_geral">
            ...
            <div class="tab-pane_ active" id="tab_a">
                <h4><small> 1 </small> Détails de l'annonce <small class="pull-right">Mise à jour anoonce services</small></h4>
